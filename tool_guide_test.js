...
(lib.tool_guide_test = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(84).call(this.frame_84).wait(1).call(this.frame_85).wait(1).call(this.frame_86).wait(23));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.no_button1}]},84).to({state:[{t:this.no_button2}]},1).to({state:[{t:this.no_button3}]},1).to({state:[]},1).to({state:[]},21).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.yes_button1}]},84).to({state:[{t:this.yes_button2}]},1).to({state:[{t:this.yes_button3}]},1).to({state:[]},1).to({state:[]},21).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.intro_text).to({alpha:1},61).wait(6).to({y:329.05,alpha:0},3).to({_off:true},38).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.try_again1).to({_off:true},108).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_706).wait(109));
